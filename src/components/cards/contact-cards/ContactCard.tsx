...
const ContactCard: ContactCardType = ({contact}) => {
  return (
    <div className="flex-1">
      <div className="py-14 px-12 h-full rounded-2xl border-2 border-primary text-center text-white hover:border-pink hover:shadow-pink ease-in-out duration-200 flex flex-col">
